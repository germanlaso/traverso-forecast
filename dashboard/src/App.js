  ...
  return (
    <div style={s.app}>
      ...
      <div className="no-print" style={{background:'#fff',borderBottom:`1px solid ${C.border}`,padding:'0 24px',display:'flex',gap:4}}>
        {[['forecast','📈 Forecast de Demanda'],['plan','🏭 Plan de Producción'],['stock','📦 Stock por SKU'],['stockdiario','📊 Stock Diario'],['detalle','🔧 Detalle Producción'],['programacion','📅 Programación Diaria'],['faltantes','📉 Faltantes']].map(([tab,label]) => (
